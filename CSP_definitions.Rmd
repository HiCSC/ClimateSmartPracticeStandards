...
sourcePDF <- pdfFiles[15]
for(sourcePDF in pdfFiles[15:18]){
...
```{sh}
diff data_lvl01/380_Windbreak_Shelterbelt_Establishment_NHCP_CPS_2021.yaml data_lvl01/380_Windbreak_Shelterbelt_Establishment_PIA_CPS_2022.yaml
```
...
```{r}
PIA380 <- read_yaml('data_lvl01/380_Windbreak_Shelterbelt_Establishment_PIA_CPS_2022.yaml')

NHCP380 <- read_yaml('data_lvl01/380_Windbreak_Shelterbelt_Establishment_NHCP_CPS_2021.yaml')
